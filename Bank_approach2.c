...
void show_menu();
void save_account();
void read_account(Bank *);
void append_account_to_list(Bank);
...
{
	Bank temp_account;
	read_account(&temp_account);
	append_account_to_list(temp_account);
	save_list_to_file();
	printf("Account saved successfully.\n");
	pause();
}

void read_account(Bank *temp_account)
{
...
void append_account_to_list(Bank temp_account)
{
